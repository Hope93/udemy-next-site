...
// keeping style here so we don't just have them in pages for any other
// page otherwise we would have to move it to components
...
const About = () => (
  <Page
    meta={{ title: 'About', description: "Peter Quill's biography" }}
  >
    <section css={header}>
      <Image
        css={pilotPicture}
